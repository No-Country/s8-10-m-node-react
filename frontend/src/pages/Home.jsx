    ...
    <>
      <section className="w-[90%] h-[300px] py-3 px-5 mx-auto flex flex-col items-center gap-10 bg-[#42ADD5] rounded-[30px] mb-7">
        <div className="w-full flex justify-between items-center">
          <FaBars size={25} />
          <h2 className=" w-20 text-center font-inter ">
            Welcome, <span className="text-xl font-bold">Carlos</span>
          </h2>
          <img
        ...
        <div className="w-full text-center relative text-white font-inter">
          ...
          <FaRegEye
            className="absolute right-2 top-[52px] text-black"
            size={24}
          />
        </div>
      ...
      <section>
        <Button func={logOut}>Cerrar sesion</Button>
      </section>
    </>
  )
}
